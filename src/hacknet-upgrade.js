...
export async function main(ns) {
	...
	while (true) {
		...
		for (var i = 0; i < ns.hacknet.numNodes(); i++) {
			...
			} else if (costMax < ns.hacknet.getCacheUpgradeCost(i, 1)) {
                killScript++;
            }
			await ns.sleep(100);
		}
